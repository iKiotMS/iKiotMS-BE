 ...
 *                     importPrice: { type: number, description: "Required for IMPORT (> 0). For EXPORT/RETURN, auto-filled with product costPrice if omitted, but can be manually overridden." }
 ...
 *                     importPrice: { type: number, description: "For EXPORT/RETURN, auto-filled with product costPrice if omitted, but can be manually overridden." }
